...
/. $putCase consumeJSXElement(); $break ./
/:$readableName JSXElementName:/

JSXClosingElement ::=  < / JSXElementName >
/. $putCase consumeJSXClosingElement(); $break ./
/:$readableName JSXClosingElement:/
JSXSelfClosingElement ::= '<'  JSXElementName JSXAttributesopt  '/' '>'
/. $putCase consumeJSXSelfClosingElement(); $break ./
/:$readableName JSXSelfClosingElement:/
JSXOpeningElement ::= < JSXElementName JSXAttributesopt >
/. $putCase consumeJSXOpeningElement(); $break ./
/:$readableName JSXSelfClosingElement:/
JSXChildren ::= JSXChild  JSXChildrenopt
/. $putCase consumeJSXChildren(); $break ./
/:$readableName JSXChildren:/
JSXChildrenopt ::= $empty
/. $putCase consumeJSXChildrenopt(); $break ./
/:$readableName JSXChildren:/
JSXChildrenopt -> JSXChildren
JSXChild ::= JSXText JSXElement { JSXChildExpressionopt }
/. $putCase consumeJSXChild(); $break ./
/:$readableName JSXChild:/

JSXChildExpressionopt ::= Expressionopt
/. $putCase consumeJSXChildExpressionopt(); $break ./
/:$readableName JSXChildExpressionopt:/
JSXText ::=  JSXTextCharacter JSXTextopt
/. $putCase consumeJSXText(); $break ./
